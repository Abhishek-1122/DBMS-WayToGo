...
<table align="center" class="tbl-full">
	...
	<table  class="but" align="center" width="180%">
        <tr><td><form class="form-inline my-2 my-lg-0" method="POST" action="add_admin.php">
		...
		if($res==TRUE)
		{
			...
			if($rows>0)
			{
				...
				while($rows=mysqli_fetch_assoc($res))
				{
				  ...
				  <td width="15%">
				   <form class="form-inline my-2 my-lg-0" method="POST" action="<?php echo SITEURL; ?>admin/update_admin.php?aid=<?php echo $aid; ?>">

				      <button class="btn btn-success my-2 my-sm-0" type="submit">Update Admin</button>
				   </form>
				 </td>
				 <td width="18%" >
				   <form class="form-inline my-2 my-lg-0" method="POST" action="<?php echo SITEURL; ?>admin/del_admin.php?aid=<?php echo $aid; ?>">
				      <button class="btn btn-danger my-2 my-sm-0" type="submit">Delete Admin</button>
				    </form>
