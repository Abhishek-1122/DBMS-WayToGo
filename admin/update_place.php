...
<h1 align="center"> Update Place</h1>
<br>
<table width="100%">
    <tr>
  ...
  <form action="" method="POST">
    <table  width="40%" align="center" >
      ...
      <tr>
        <td>image: </td>
        <td><input type="file" name="imagename" value="<?php echo $imagename ?>"></td>
      </tr>
...
<?php 
  if(isset($_POST['submit']))
  {
    ...
    {
      //admin updated
      $_SESSION['update']="Place updated successfully";
      header("location:".SITEURL."admin/manage_places.php");
    ...
    {
      //failed
       $_SESSION['update']="Failed to update place";
      header("location:".SITEURL."admin/manage_places.php");
    }
  }
?>
